...
export const journey:Scene[]=[
 ...
 {stage:4,title:"Kilning",kicker:"05 — THE INTELLIGENCE LAYER IN ACTION",subtitle:"Four AI use cases, one connected view.",text:"Inside the kiln, AI can connect energy, quality, maintenance and production planning to support better operational decisions."},
